	...
	<table class="table table-striped">
      ...
      // Get Result
               ...
               if($result['payment_status']=='1'){
               	?>
            <a class="btn-primary" href="Api/payment.api.php?paymentid=<?php echo $result['bill_id'] ?> "onclick="return confirm('Are you sure to payment?');">Payment</a></td>
               	...
               	?>
               <a class="btn-success" disabled>Payment Successfully</a></td>
